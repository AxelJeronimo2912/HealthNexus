        ...
        <div class="flex items-center justify-between gap-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-500">Actualiza los permisos y menús visibles del rol</p>
                </div>
            </div>
        ...
        <div class="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div class="mb-6 grid grid-cols-1 gap-4 sm:grid-cols-3">
                <div class="flex items-center gap-4 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                    ...
                    <div>
                        <p class="text-[11px] font-semibold uppercase tracking-wider text-slate-500">Rol</p>
                        <p class="text-lg font-bold capitalize text-slate-900">{{ $role->name }}</p>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-4 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                    ...
                    <div>
                        ...
                        <p class="text-lg font-bold text-slate-900">{{ $totalSeleccionados }} asignados</p>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-4 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                    ...
                    <div>
                        ...
                        <p class="text-lg font-bold text-slate-900">{{ $role->users->count() }}</p>
                    </div>
                </div>
            </div>
            ...
            <form action="{{ route('admin.roles.update', $role) }}" method="POST"
                ...
                <div class="border-b border-slate-100 px-6 py-5">
                    ...
                    <p class="text-xs text-slate-500">Modifica el nombre y los menús visibles.</p>
                </div>
