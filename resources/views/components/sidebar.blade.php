@php
    ...
    // Estilos base utilizando tu color primario (#172554) y secundario (#7C3AED)
...
<aside
    ...
    <div class="px-4 py-3 border-b border-slate-800/60 text-xs min-w-[256px] flex items-center gap-3">
        ...
        <div class="opacity-0 group-hover/sidebar:opacity-100 transition-opacity duration-300 whitespace-nowrap overflow-hidden">
            <p class="text-slate-400 text-[10px] uppercase tracking-wider leading-none">Rol activo</p>
            <p class="text-white font-semibold text-xs mt-0.5">{{ ucfirst($rol ?? 'Sin rol') }}</p>
        </div>
    </div>
    ...
    <nav class="flex-1 overflow-y-auto px-2 py-3 space-y-1 text-sm scrollbar-thin scrollbar-thumb-slate-700">
        ...
        <a href="{{ route('dashboard') }}"
            ...
            <span class="ml-3 whitespace-nowrap opacity-0 group-hover/sidebar:opacity-100 transition-opacity duration-300">Dashboard</span>
        </a>
        ...
        @canany(['pacientes.ver', 'admision.ver', 'servicios.ver', 'especialidades.ver', 'citas.ver', 'turnos.ver', 'camas.ver'])
            ...
            @can('pacientes.ver')
                <a href="{{ route('pacientes.index') }}"
                    ...
                    <span class="ml-3 whitespace-nowrap opacity-0 group-hover/sidebar:opacity-100 transition-opacity duration-300">Pacientes</span>
                </a>
            @endcan
            ...
            @can('admision.ver')
                <a href="#" class="{{ $linkBase }}">
                    ...
                    <span class="ml-3 whitespace-nowrap opacity-0 group-hover/sidebar:opacity-100 transition-opacity duration-300">Admision</span>
                </a>
            @endcan
            ...
            @can('servicios.ver')
                <a href="#" class="{{ $linkBase }}">
                    ...
                    <span class="ml-3 whitespace-nowrap opacity-0 group-hover/sidebar:opacity-100 transition-opacity duration-300">Servicios</span>
                </a>
            @endcan
            ...
            @can('especialidades.ver')
                <a href="#" class="{{ $linkBase }}">
                    ...
                    <span class="ml-3 whitespace-nowrap opacity-0 group-hover/sidebar:opacity-100 transition-opacity duration-300">Especialidades</span>
                </a>
            @endcan
            ...
            @can('citas.ver')
                <a href="{{ route('citas.index') }}"
                    ...
                    <span class="ml-3 whitespace-nowrap opacity-0 group-hover/sidebar:opacity-100 transition-opacity duration-300">Citas</span>
                </a>
            @endcan
            ...
            @can('turnos.ver')
                <a href="{{ route('admin.turnos.index') }}"
                    ...
                    <span class="ml-3 whitespace-nowrap opacity-0 group-hover/sidebar:opacity-100 transition-opacity duration-300">Turnos</span>
                </a>
            @endcan
            ...
            @can('camas.ver')
                <a href="{{ route('camas.index') }}"
                    ...
                    <span class="ml-3 whitespace-nowrap opacity-0 group-hover/sidebar:opacity-100 transition-opacity duration-300">Camas</span>
                </a>
            @endcan
        @endcanany
        ...
        @can('agenda.ver')
            ...
            <a href="{{ route('agenda.index') }}"
                ...
                <x-heroicon-o-calendar-days class="w-5 h-5 shrink-0" />
                <span class="ml-3 whitespace-nowrap opacity-0 group-hover/sidebar:opacity-100 transition-opacity duration-300">Calendario de Citas</span>
            </a>
            <a href="{{ route('agenda.create') }}"
                class="{{ $linkBase }} {{ request()->routeIs('agenda.create') ? $linkActivo : '' }}">
                <x-heroicon-o-plus-circle class="w-5 h-5 shrink-0" />
                <span class="ml-3 whitespace-nowrap opacity-0 group-hover/sidebar:opacity-100 transition-opacity duration-300">Nueva Cita</span>
            </a>
        @endcan
        ...
        @canany(['expediente.ver', 'consultas.ver', 'enfermeria.ver', 'seguimiento.ver', 'signos-vitales.ver'])
            ...
            @can('expediente.ver')
                <a href="{{ route('expedientes.index') }}"
                    ...
                    <span class="ml-3 whitespace-nowrap opacity-0 group-hover/sidebar:opacity-100 transition-opacity duration-300">Expediente</span>
                </a>
            @endcan
            ...
            @can('consultas.ver')
                <a href="{{ route('citas.index') }}"
                    ...
                    <span class="ml-3 whitespace-nowrap opacity-0 group-hover/sidebar:opacity-100 transition-opacity duration-300">Consultas</span>
                </a>
            @endcan
            ...
            @can('enfermeria.ver')
                <a href="#" class="{{ $linkBase }}">
                    ...
                    <span class="ml-3 whitespace-nowrap opacity-0 group-hover/sidebar:opacity-100 transition-opacity duration-300">Enfermeria</span>
                </a>
            @endcan
            ...
            @can('seguimiento.ver')
                <a href="{{ route('seguimientos.index') }}"
                    ...
                    <span class="ml-3 whitespace-nowrap opacity-0 group-hover/sidebar:opacity-100 transition-opacity duration-300">Seguimiento</span>
                </a>
            @endcan
            ...
            @can('signos-vitales.ver')
                <a href="{{ route('signos-vitales.index') }}"
                    ...
                    <x-heroicon-o-heart class="w-5 h-5 shrink-0" />
                    <span class="ml-3 whitespace-nowrap opacity-0 group-hover/sidebar:opacity-100 transition-opacity duration-300">Signos Vitales</span>
                </a>
            @endcan
        @endcanany
        ...
        @canany(['medicamentos.ver', 'dispensaciones.ver', 'existencias.ver', 'movimientos.ver', 'prediccion.ver'])
            ...
            @can('medicamentos.ver')
                <a href="{{ route('medicamentos.index') }}"
                    ...
                    <span class="ml-3 whitespace-nowrap opacity-0 group-hover/sidebar:opacity-100 transition-opacity duration-300">Medicamentos</span>
                </a>
            @endcan
            ...
            @can('dispensaciones.ver')
                <a href="{{ route('dispensaciones.index') }}"
                    ...
                    <x-heroicon-o-clipboard-document-list class="w-5 h-5 shrink-0" />
                    <span class="ml-3 whitespace-nowrap opacity-0 group-hover/sidebar:opacity-100 transition-opacity duration-300">Recetas</span>
                </a>
            @endcan
            ...
            @can('existencias.ver')
                <a href="{{ route('existencias.index') }}"
                    ...
                    <span class="ml-3 whitespace-nowrap opacity-0 group-hover/sidebar:opacity-100 transition-opacity duration-300">Existencias</span>
                </a>
            @endcan
            ...
            @can('movimientos.ver')
                <a href="#" class="{{ $linkBase }}">
                    ...
                    <span class="ml-3 whitespace-nowrap opacity-0 group-hover/sidebar:opacity-100 transition-opacity duration-300">Movimientos</span>
                </a>
            @endcan
            ...
            @can('prediccion.ver')
                <a href="#" class="{{ $linkBase }}">
                    ...
                    <span class="ml-3 whitespace-nowrap opacity-0 group-hover/sidebar:opacity-100 transition-opacity duration-300">Prediccion IA</span>
                </a>
            @endcan
        @endcanany
        ...
        @canany(['usuarios.ver', 'roles.ver', 'dispositivos.ver', 'auditoria.ver', 'asistente.ver', 'alertas.ver'])
            ...
            @can('usuarios.ver')
                <a href="{{ route('admin.users.index') }}"
                    ...
                    <span class="ml-3 whitespace-nowrap opacity-0 group-hover/sidebar:opacity-100 transition-opacity duration-300">Usuarios</span>
                </a>
            @endcan
            ...
            @can('roles.ver')
                <a href="{{ route('admin.roles.index') }}"
                    ...
                    <span class="ml-3 whitespace-nowrap opacity-0 group-hover/sidebar:opacity-100 transition-opacity duration-300">Roles y Permisos</span>
                </a>
            @endcan
            ...
            @can('dispositivos.ver')
                <a href="#" class="{{ $linkBase }}">
                    ...
                    <span class="ml-3 whitespace-nowrap opacity-0 group-hover/sidebar:opacity-100 transition-opacity duration-300">Dispositivos</span>
                </a>
            @endcan
            ...
            @can('auditoria.ver')
                <a href="#" class="{{ $linkBase }}">
                    <x-heroicon-o-clipboard-document-list class="w-5 h-5 shrink-0" />
                    <span class="ml-3 whitespace-nowrap opacity-0 group-hover/sidebar:opacity-100 transition-opacity duration-300">Auditoria</span>
                </a>
            @endcan
            ...
            @can('asistente.ver')
                <a href="#" class="{{ $linkBase }}">
                    ...
                    <span class="ml-3 whitespace-nowrap opacity-0 group-hover/sidebar:opacity-100 transition-opacity duration-300">Asistente IA</span>
                </a>
            @endcan
            ...
            @can('alertas.ver')
                <a href="#" class="{{ $linkBase }}">
                    ...
                    <span class="ml-3 whitespace-nowrap opacity-0 group-hover/sidebar:opacity-100 transition-opacity duration-300">Alertas Inteligentes</span>
                </a>
            @endcan
        @endcanany
    ...
    <div class="border-t border-slate-800/60 p-2 min-w-[256px]">
        <form method="POST" action="{{ route('logout') }}">
            @csrf
            <button type="submit" class="w-full text-slate-300 hover:text-[#EF4444] hover:bg-[#EF4444]/10 {{ $linkBase }}">
                <x-heroicon-o-arrow-right-on-rectangle class="w-5 h-5 shrink-0 text-[#EF4444]" />
                <span class="ml-3 whitespace-nowrap opacity-0 group-hover/sidebar:opacity-100 transition-opacity duration-300">Cerrar sesion</span>
            </button>
        </form>
    </div>
</aside>
...
<button @click="abierto = true" class="fixed top-3 left-3 z-40 lg:hidden bg-[#172554] text-white p-2 rounded-xl shadow-lg border border-[#172554]/50">
